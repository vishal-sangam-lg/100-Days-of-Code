# Syntax is old. Use 'By' class for find method
...
#
# sleep(2) login_button = driver.find_element_by_xpath('//*[@id="content"]/div/div[1]/div/main/div[
# 1]/div/div/header/div[1]/div[2]/div/button') login_button.click()
#
# sleep(2)
